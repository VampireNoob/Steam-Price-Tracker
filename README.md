...
- **Web frontend** (`app.py`, Flask) — a browser-based view of the same data: see tracked games with current price/discount, search and add new games, remove games, and trigger a manual price check, all from `http://127.0.0.1:5000`.
